...
TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "luxury": {
        ...
        "cover_override": (
            ...
            "double-line gold border frame inset ~24px from the cover's outer edge, running the full perimeter "
            "(like an invitation/certificate border), with small ornamental gold corner brackets (simple CSS "
            "borders, ~24px) at all four corners just inside the frame. Business name: gold-tinted white, "
    ...
    "startup": {
        ...
        "cover_override": (
            ...
            "is a SPLIT layout, never the single centered column described above. Left column (~55% width): "
            "top bar logo/label, then business name left-aligned in bold geometric sans (4rem), tagline below, "
